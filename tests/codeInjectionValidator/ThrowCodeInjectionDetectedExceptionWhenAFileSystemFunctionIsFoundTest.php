...
class ThrowCodeInjectionDetectedExceptionWhenAFileSystemFunctionIsFoundTest extends CustomizedTestCase
{
    ...
    {
        $sourceCodeFile = $this->getFixtureFilesPath() . 'sourceCodeFiles' . DIRECTORY_SEPARATOR . 'SourceCodeWithFileSystemFunctionsSourceCode.php';
