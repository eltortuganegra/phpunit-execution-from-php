...
class ThrowCodeInjectionDetectedExceptionWhenAProgramExecutionFunctionIsFoundTest extends CustomizedTestCase
{
    ...
    {
        $sourceCodeFile = $this->getFixtureFilesPath() . 'sourceCodeFiles' . DIRECTORY_SEPARATOR . 'SourceCodeWithProgramExecutionFunctionsSourceCode.php';
